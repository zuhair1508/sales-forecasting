...
│
├── pyproject.toml     <- Project configuration file with package metadata for sales_forecasting
...
│
└── sales_forecasting                <- Source code for use in this project.
    │
    ├── __init__.py    <- Makes sales_forecasting a Python module
    │
